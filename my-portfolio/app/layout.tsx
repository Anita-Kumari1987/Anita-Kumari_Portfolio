...
export default function RootLayout({ children }: { children: ReactNode }) {
  return (
    <html lang="en" className="h-full">
      <body
        className={`${outfit.variable} ${dancingScript.variable} ${rajdhani.variable} font-sans text-white relative overflow-x-hidden h-full`}
        style={{
      ...
      <main
        id="main-content"
  className="min-h-screen px-4 md:px-8 py-8 relative z-10 md:ml-[280px] xl:ml-[340px] flex flex-col items-center"
      >
